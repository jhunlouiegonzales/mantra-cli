...
export function generateModule(name, options, customConfig = {}) {
  ...
  createFile(`${templatesPath}/imports/modules/core/actions/index.js`,
    `${modulePath}/actions/index.js`);

  createFile(`${templatesPath}/imports/modules/core/index.js`,
    `${modulePath}/index.js`);
  ...
  if(name === 'core') 
  {
    ...
    createFile(`${templatesPath}/imports/modules/core/routes.tt`,
      `${modulePath}/routes.${config.jsxExtension}`);

    createFile(`${templatesPath}/imports/modules/core/components/main_layout.jsx`,
           `${modulePath}/components/main_layout.${config.jsxExtension}`);

     createFile(`${templatesPath}/imports/modules/core/components/home.jsx`,
  ...
  if (config.storybook) {
    ...
    createFile(`${templatesPath}/imports/modules/core/components/.stories/index.js`,
      moduleStoriesIndex);
  }
}
