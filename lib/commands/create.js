...
export default function create(appPath, options = {}) {
  ...
  createFile(`${templatesPath}/imports/configs/context.js`,
           `${appPath}/imports/configs/context.js`);

  createFile(`${templatesPath}/client/main.js`,
           `${appPath}/client/main.js`);

  createFile(`${templatesPath}/imports/lib/collections/index.js`,
           `${appPath}/imports/lib/collections/index.js`);
  ...
  console.log('');
  console.log(`Created a new app using Mantra v1.0.0 at ${appPath}`);
  console.log('');
